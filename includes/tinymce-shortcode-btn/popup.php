<?php
	...
	if ( ! is_user_logged_in() || !current_user_can( 'edit_posts' ) )
		wp_die( __( 'Oops! You can\'t call this page directly.' ) );
?>
<!doctype html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<title>Add Modal Login Shortcode</title>
	...
	<body id="shortcode-form" class="wp-core-ui" onLoad="tinyMCEPopup.executeOnLoad( 'init();' );">
		<form name="wp_modal_shortcode" action="#">
			<table class="form-table" style="width:90%;">
				<tr valign="top">
					<th scope="row">
						<label for="login-text">Login Text</label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="logout-text">Logout Text</label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="logout-url">Logout Redirect URL</label>
					</th>
					<td>
